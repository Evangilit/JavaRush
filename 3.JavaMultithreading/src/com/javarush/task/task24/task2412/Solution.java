    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (compareNames == 0){
                    int stock1Year = ((Date)stock1.get("date")).getYear();
                    int stock2Year = ((Date)stock2.get("date")).getYear();
                    int stock1Month = ((Date)stock1.get("date")).getMonth();
                    int stock2Month = ((Date)stock2.get("date")).getMonth();
                    int stock1Day = ((Date)stock1.get("date")).getDate();
                    int stock2Day = ((Date)stock2.get("date")).getDate();
                    Date stock1Date = new Date(stock1Year, stock1Month, stock1Day);
                    Date stock2Date = new Date(stock2Year, stock2Month, stock2Day);
                    int compareDates = stock2Date.compareTo(stock1Date);
                    if (compareDates == 0){
                        double change1;
                        ...
                        double difference = change2 - change1;
                        if (difference < 0){
                            return -1;
