...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            OutputStream outputStream = new FileOutputStream("D:TestFolder/file.txt");
            InputStream inputStream = new FileInputStream("D:TestFolder/file.txt");
